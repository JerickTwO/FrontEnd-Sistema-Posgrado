...
export const extraSteps = [
    { path: '/apps/paso/extra/cambio-de-asesor', label: '1: Cambio de Asesor' },
    { path: '/apps/paso/extra/ampliacion-de-proceso', label: '2: Ampliación de Proceso' },
    { path: '/apps/paso/extra/recomposicion-de-jurados', label: '3: Recomposición de Jurado' },
];
