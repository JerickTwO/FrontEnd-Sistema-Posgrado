...
const ApprovalUpload = ({ projectId, meetsRequirements, observations }) => {
    ...
    useEffect(() => {
        ...
        projectApprovalService.viewPdfBase64(projectId)
            .then((response) => {
        ...
        projectApprovalService.viewDocBase64(projectId)
            .then((response) => {
            ...
            if (result.isConfirmed) {
                ...
                reader.onload = (e) => {
                    ...
                    projectApprovalService
                        .uploadPdfBase64(projectId, base64PDF)
                        .then(() => {
                            Swal.fire({
                                icon: 'success',
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                reader.onload = (e) => {
                    ...
                    projectApprovalService
                        .uploadDocBase64(projectId, base64Doc)
                        .then(() => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Archivo cargado con éxito',
