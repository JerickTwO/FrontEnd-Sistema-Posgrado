...
const PdfCartaMultipleSorteo = ({ infoStep, institutionalInfo, incrementFields }) => {
    ...
    return (
        <PdfBase commemorativeText={false} registrationNumber={incrementFields?.regNumber}>
            ...
            <View style={styles.section}>
                <Text style={styles.justify}>Tamburco, {actualDate}</Text>
            </View>
            <View style={styles.section}>
            ...
            <View style={[styles.section, { flexDirection: 'row', alignItems: 'flex-start' }]}>
                <View style={{ width: '18%', minWidth: 80 }}>
...
export default PdfCartaMultipleSorteo;
